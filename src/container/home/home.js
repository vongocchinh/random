...
import * as action from './../../action/home';
 class home extends Component {
    ...
    render() {
        ...
        // console.log(HomeMyReducer);
        var arrNew=HomeMyReducer.arr;
        var input=arrNew.join(" ");
        return (
            <HomeComponent onInput={this.onInput} HomeMyReducer={HomeMyReducer}  deleteData={this.deleteData} deleteDataArr={this.deleteDataArr} input={input}/>
        )
    }
}
